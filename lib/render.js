...
const NAV = [
  // Oferte, contracte, scadențe și alocări nu stau în bara principală:
  // toate sunt lucruri de CRM și se ajunge la ele din subnavigația CRM.
...
// cinci module — până acum era copiată în fiecare, ca să nu se ceară unele
// pe altele în cerc.
...
module.exports = { esc, money, layout, table, actionLinks, subnavCrm, NAV };
