...
const NAV = [
  ...
  { href: "/configurari/date", label: "Configurări", zona: "/configurari", doarAdmin: true },
...
module.exports = { esc, money, avatar, layout, table, actionLinks, subnavCrm, subnavDepozit, subnavFinanciar, subnavProductie, subnavAdmin, subnavPentru, sectiune, NAV };
