...
const NAV = [
  ...
  // Dezvoltarea a coborat si ea sub Management, dupa Email: cererile de
  // modificare in soft sunt treaba celui care conduce firma, nu o zona de
  // lucru de zi cu zi. Scrierea ramane a tuturor (vezi MEREU_PERMISE din
  // lib/auth) — doar locul din meniu s-a schimbat, nu si dreptul.
  //
  ...
  // aprinde. Cele doua nu-s acelasi lucru: /email si /dezvoltare sunt deschise
  // oricui (MEREU_PERMISE), deci puse in „zone" ar fi facut Managementul
  // vizibil pentru toata lumea. Asa, omul de la depozit intrat pe /dezvoltare
  // vede intrarea aprinsa doar daca are oricum drept la ea.
  {
    href: "/",
    label: "Management",
    zone: ["/", "/rapoarte", "/configurari", "/admin/utilizatori"],
    evidentiaza: ["/email", "/dezvoltare"],
  },
];
