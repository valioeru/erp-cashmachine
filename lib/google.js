...
function explica(r, casuta) {
  ...
  if (motiv === "notFound" || (r && r.cod === 404))
    return `Google nu găsește folderul cu ID-ul din GOOGLE_DRIVE_FOLDER. Verifică să fie bucata de după /folders/ din adresa folderului, nu a Drive-ului și nu tot linkul. Pasul 3 din ghid. (${d || motiv})`;
