...
async function trimiteDeLa(u, mesaj) {
  const expeditor = String((u && (u.email_expeditor || u.email)) || "").trim();
  let refuzGmail = null;
...
module.exports = { trimite, trimiteDeLa, cifreaza, descifreaza, configUtilizator, presetPentru, PRESETURI };
