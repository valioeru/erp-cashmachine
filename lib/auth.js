...
const ACCES_ROL = {
  vanzari: ["/", "/parteneri", "/crm", "/taskuri", "/profil", "/comenzi", "/produse", "/stocuri", "/rapoarte/pipeline", "/rapoarte/clienti"],
  financiar: ["/", "/parteneri", "/facturi", "/rapoarte", "/taskuri", "/profil", "/angajati", "/salarii"],
  depozit: ["/", "/produse", "/stocuri", "/import", "/taskuri", "/profil", "/comenzi", "/rapoarte/stocuri", "/rapoarte/comenzi"],
};
