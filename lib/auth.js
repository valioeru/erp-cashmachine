...
const ACCES_ROL = {
  ...
  vanzari: ["/crm", "/scadente", "/oferte", "/contracte", "/comenzi", "/parteneri", "/taskuri", "/profil", "/produse", "/calculator", "/warehouse/comanda"],
  financiar: ["/", "/parteneri", "/scadente", "/oferte", "/contracte", "/facturi", "/rapoarte", "/banca", "/taskuri", "/profil", "/angajati", "/salarii", "/costuri", "/financiar", "/comenzi", "/calculator"],
  depozit: ["/", "/produse", "/stocuri", "/depozite", "/warehouse", "/import", "/taskuri", "/profil", "/comenzi", "/productie", "/rapoarte/stocuri", "/rapoarte/comenzi", "/facturi/achizitii"],
