...
class Router {
  ...
  // Necesar pentru puntea de import: cererea vine de pe alt domeniu
  // (cloud.smartbill.ro), deci browserul trimite întâi un preflight OPTIONS.
    ...
    req.on("end", () => {
      try {
        ...
        if (contentType.startsWith("multipart/form-data")) {
          ...
          // Puntea de import trimite JSON — rânduri citite din SmartBill.
